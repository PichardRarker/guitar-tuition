...
<img width="350" height="350" alt="Screenshot 2025-08-04 190110" src="https://github.com/user-attachments/assets/0737883d-5a4b-40d9-88ad-06d3568d8b57" />



<br/><br/>

## :cold_sweat: More involved: the 3 note approach
...
<img width="515" height="517" alt="RSYxTe8S1bgico8dupyIyxgJ5uhoTt636HL4hvag" src="https://github.com/user-attachments/assets/5ba8d182-00d2-4c35-80a8-3e3c518d2dae" />


**This is 3 notes, how can this still be a power chord?** Because this extra note is just another `F` (an octave higher on the `F` played on the 6th string). Even though 3 strings are being fretted, we are only playing `F` and `C` notes (multiple `F`s, x1 `C`), so it's still a power chord
